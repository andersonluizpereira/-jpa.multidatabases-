package com.examplo.jpa.multidatabases.config;
...
@EnableJpaRepositories(entityManagerFactoryRef = "mysqlEntityManagerFactory", transactionManagerRef = "mysqlTransactionManager", basePackages = {"com.examplo.jpa.multidatabases.repository.mysql"})
...
public class MySqlConfig {
    ...
    public LocalContainerEntityManagerFactoryBean mysqlEntityManagerFactory(@Qualifier("mysqlDataSource") DataSource hubDataSource, EntityManagerFactoryBuilder builder) {
        return builder.dataSource(hubDataSource).packages("com.examplo.jpa.multidatabases.domain.mysql")
